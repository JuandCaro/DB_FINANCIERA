...
(
    ...
    nom_departamento      VARCHAR                       NOT NULL    CHECK   (LENGTH(nom_departamento) >=30  AND LENGTH(nom_departamento) <=60),
    usr_insert            VARCHAR                       NOT NULL, 
    fec_insert            TIMESTAMP WITHOUT TIME ZONE   NOT NULL,  
	usr_update            VARCHAR                           NULL,
	fec_update            TIMESTAMP WITHOUT TIME ZONE       NULL,
...
(
    id_tercero	            VARCHAR                        NOT NULL       CHECK (id_inversor =10),
...
(
    ...
    id_pmtro_financiero	    VARCHAR                        NOT NULL       CHECK (),
